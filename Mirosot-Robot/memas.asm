...
TMR0_MdOnMiOn		EQU d'8'			; Multiplo del tiempo base del TMR0 a ejecutar con MD_on_MI_on.
TMR0_MdOffMiOn		EQU d'1'			; Multiplo del tiempo base del TMR0 a ejecutar con MD_off_MI_on.
...
Configuracion1
	...
	movlw	d'5'					; Numero de veces a repetirse el tiempo base de 500ms
	goto	TMR1_CargaRepeticiones	; del TMR1 para la Programacion 1.
Configuracion2
	incf	TMR1_Programa,F
	movlw	d'6'					; Numero de veces a repetirse el tiempo base de 500ms
...
TMR1_FinInterrupcion
	bsf		T1CON,TMR1ON
	bcf		PIR1,TMR1IF				; Repone flag del TMR0.
	retfie							; Retorno de interrupción.
...
;ZONA DE ARCHIVOS INCLUIDOS EN LA PROGRAMACIÓN------------------------------------------------------------
	...
	include<MovimientosPWM.asm>
	include<retardos.asm>
	include<ProgramasUsados.asm>
